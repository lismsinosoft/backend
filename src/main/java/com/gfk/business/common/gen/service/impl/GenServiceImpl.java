package com.gfk.business.common.gen.service.impl;
...
import com.gfk.framework.plugin.velocity.VelocityInitializer;
...
public class GenServiceImpl implements GenService {
    ...
    public void genFile(GenFileForm form) {
        ...
        log.info("gen file: {}", targetFilePath);
            ...
            if (form.getBaseColumnFlag() != null && form.getBaseColumnFlag().equals(Boolean.TRUE)) {
                ...
                columnStrBuilder.append(
                        "  `id` varchar(40) NOT NULL, " +
                                ...
                                "  `logic_delete` bit(1) DEFAULT 0 NOT NULL, ");
            }
