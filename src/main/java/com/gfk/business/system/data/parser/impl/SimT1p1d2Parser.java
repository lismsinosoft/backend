 ...
 */
@Slf4j
public class SimT1p1d2Parser extends AbstractParser implements BaseParser {
    protected final List<SimT1p1> totalData = new ArrayList<>();
    private final ImportEnum importEnum = ImportEnum.SIM_T1P1D2;

    public SimT1p1d2Parser(Long projectId) {
        super(projectId);
    }
    ...
    public void parseData(Map<Integer, String> headMap, Map<Integer, String> data) {
        ...
        entity.setLabel(entity.getType1());
