...
/**
 * Curve Important Excel导入Listener
 *
 * @author wzl
 * @version 1.0 2023/5/17
 */
@Slf4j
public class CurveImportantImportListener implements ReadListener<CurveImportantImport> {
     ...
     * 缓存数据
     */
    private final List<CurveImportantImport> cachedList = new ArrayList<>(CACHE_SIZE);


    public CurveImportantImportListener(Long projectId, String taskId, DataImportService service) {
    ...
    @Override
    public void invoke(CurveImportantImport data, AnalysisContext context) {
    ...
    private void saveData() {
        try {
            ...
            int i = service.saveCurveImportant(cachedList);
