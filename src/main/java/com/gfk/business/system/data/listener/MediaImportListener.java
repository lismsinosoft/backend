 ...
 */
@Slf4j
public class MediaImportListener implements ReadListener<MediaImport> {
     ...
     * 缓存数据
     */
    private List<MediaImport> cachedList = new ArrayList<>(CACHE_SIZE);


    public MediaImportListener(Long projectId, String taskId, DataImportService service) {
    ...
    @Override
    public void invoke(MediaImport data, AnalysisContext context) {
    ...
    private void saveData() {
        try {
            ...
            int i = service.saveMedia(cachedList);
