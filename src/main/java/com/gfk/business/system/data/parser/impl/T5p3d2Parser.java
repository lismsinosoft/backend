 ...
 */
@Slf4j
public class T5p3d2Parser extends AbstractParser implements BaseParser {
    protected final List<T5p3> totalData = new ArrayList<>();
    private final ImportEnum importEnum = ImportEnum.T5P3D2;

    public T5p3d2Parser(Long projectId) {
        super(projectId);
    }
